        ...
        matching_data = [
            {
                ...
                "members": [
                    {"nickname": "에덴", "domains": "핀테크 / 금융, 커머스 / 로컬 플랫폼", "companies": "우아한형제들, 토스뱅크, 당근, 네이버쇼핑"},
                    {"nickname": "샤를", "domains": "핀테크 / 금융, 포털 / 글로벌 빅테크 / 인프라", "companies": "토스뱅크, 네이버쇼핑, 현대자동차"},
                    {"nickname": "이안", "domains": "핀테크 / 금융, 커머스 / 로컬 플랫폼, 컨텐츠 / 엔터테인먼트 / 미디어, 포털 / 글로벌 빅테크 / 인프라", "companies": "네이버, 카카오, 우아한형제들, 토스, 당근, 현대자동차"}
                ]
            },
            {
                "group_name": "핀테크 금융 인프라 B조",
                "members": [
                    {"nickname": "로지", "domains": "핀테크 / 금융, 커머스 / 로컬 플랫폼", "companies": "우아한형제들, 토스뱅크, 토스증권, 카카오뱅크, 네이버파이낸셜"},
                    {"nickname": "마이찬", "domains": "핀테크 / 금융, 커머스 / 로컬 플랫폼", "companies": "우아한형제들, 딜리버리히어로, 네이버파이낸셜, 네이버클라우드, 토스뱅크, 토스증권, 카카오뱅크"},
                    {"nickname": "피노", "domains": "핀테크 / 금융, 커머스 / 로컬 플랫폼", "companies": "네이버, 카카오, 우아한형제들, 토스뱅크"},
            ...
            },
            {
                ...
                "members": [
                    {"nickname": "카야", "domains": "핀테크 / 금융, 커머스 / 로컬 플랫폼", "companies": "네이버, 카카오, 우아한형제들, 당근, 토스뱅크, NOL"},
                    {"nickname": "모카", "domains": "핀테크 / 금융, 커머스 / 로컬 플랫폼", "companies": "우아한형제들, 토스, 당근, 네이버쇼핑, 카카오모빌리티"},
                    {"nickname": "바니", "domains": "커머스 / 로컬 플랫폼, 컨텐츠 / 엔터테인먼트 / 미디어, 포털 / 글로벌 빅테크 / 인프라", "companies": "네이버, 라인, 우아한형제들, 당근, 지그재그, 무신사, 올리브영, NOL"},
                    {"nickname": "이삭", "domains": "커머스 / 로컬 플랫폼, 포털 / 글로벌 빅테크 / 인프라", "companies": "올리브영, 쿠팡"},
                    {"nickname": "러키", "domains": "커머스 / 로컬 플랫폼", "companies": "당근"},
                    {"nickname": "피즈", "domains": "커머스 / 로컬 플랫폼, 컨텐츠 / 엔터테인먼트 / 미디어, 포털 / 글로벌 빅테크 / 인프라", "companies": "네이버, 카카오, 라인, 쿠팡, 우아한형제들, 토스"}
                ]
            },
            {
                "group_name": "컨텐츠 플랫폼 미디어 인프라조",
                "members": [
                    {"nickname": "소낙눈", "domains": "커머스 / 로컬 플랫폼, 컨텐츠 / 엔터테인먼트 / 미디어", "companies": "네이버, 우아한형제들, 치지직, NOL, 위버스컴퍼니, 디어유, 샌드박스네트워크, 레진엔터테인먼트"},
                    {"nickname": "이산", "domains": "커머스 / 로컬 플랫폼, 컨텐츠 / 엔터테인먼트 / 미디어, 포털 / 글로벌 빅테크 / 인프라", "companies": "라인, 쿠팡, 우아한형제들, NOL, 네이버웹툰, 밀리의서재, 교보문고, 티빙, 리디, 라프텔, 핏펫, 엠넷플러스, 네이버랩스, 알라딘, 오늘의집, 네이버플러스스토어, 가비아"},
                    {"nickname": "초록", "domains": "컨텐츠 / 엔터테인먼트 / 미디어, 포털 / 글로벌 빅테크 / 인프라", "companies": "우아한형제들, 치지직, 토스증권, 카카오웹툰, 네이버웹툰, 업스테이지, 네이버검색, 네이버쇼핑, 두나무, NOL, 여기어때"},
